package io.flutter.plugins.webviewflutter.filechooser;
...
public class FileChooser {
    ...
    private Uri getOutputFilename(String intentType) {
        ...
        // FIXME: 2022/4/12 此处对应声明文件中配置地址
        String authority = packageName + ".webviewflutter.filechooser.file_chooser_flutter_provider";
